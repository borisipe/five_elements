...
function Testimonios() {
    return (
      ...
      <div className="row p-3 p-md-5" style={{ maxWidth: "100%" }}>
        ...
        <div className="card mb-3 mb-sm-0 col-12 col-sm-6" style={{ maxWidth: "540px" }}>
          <div className="card-body">
            <h5 className="card-title">"Cuando mi hijo tenía 4 años, hacía sonar mucho los dientes cuando dormía...buscando ayuda para él llegué con Fabiola y la terapia de gotitas....lo cual le sirvió muchísimo...luego partí yo...de eso ya han pasado 9 años...y definitivamente más que una terapia, ha sido un acompañamiento en este proceso llamado vida.. si la recomendaría??? La respuesta es clara: una y mil veces!!! En ella he confiado a mi hijo, a mis hermanas, a mi mamá y a mi misma...no es solo relajación o meditación, es una guía para poder conocerse, gestionar emociones e incluso entrega herramientas para la vida. Con ella he podido cerrar etapas, tomar decisiones y ver que la vida es mucho más llevadera, bella y simple de lo que uno muchas veces piensa y se encierra. Para mi no es una terapia..  es un regalo que me doy".</h5>
            <p className="card-text">Cristina C.C. Santiago</p>
          </div>
        </div>
